...
const AreaComponent = ({ onSelectedItemsChange }) => {
  ...
  return (
    <div className="AreaBoxContainer">
      <div className="Areas">
        <Areas VisibleItemCount="10" label="직무/직업" list={dataJobs} onItemClick={handleItemClick} />
        <Areas VisibleItemCount="10" label="전문분야" list={dataFields} onItemClick={handleItemClick} />
        <Areas VisibleItemCount="10" label="기술스택" list={dataSkills} onItemClick={handleItemClick} />
      </div>
