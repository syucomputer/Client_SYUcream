...
const Nav = ({ isLoggedIn }) => {
  ...
  return (
    ...
    >
      <NavLink to='/' className="NavLink" style={user ? active : {}}>홈</NavLink>
      <NavLink to='/trends' className="NavLink" style={user ? active : {}}>최신 동향</NavLink>
      <NavLink to='/subject' className="NavLink" style={user ? active : {}}>과목 추천</NavLink>
      <NavLink to='/roadmap' className="NavLink" style={user ? active : {}}>로드맵 생성</NavLink>
      <div
        style={{
          display: "flex",
          position: "absolute",
